...
UENUM(BlueprintType)
enum class EPXRSwiftMode: uint8
{
...
public:
	...
	EPXRBodyTrackingMode StartMode = EPXRBodyTrackingMode::PXR_BTM_DISABLE;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "PXR|BodyTracking")
	EPXRSwiftMode SwiftMode = EPXRSwiftMode::SWIFT_FULLBODY;
...
{
	PxrUnknown = 0 UMETA(DisplayName = "UNKNOWN"),
	PxrSwift_1 = 1 UMETA(DisplayName = "PXR_SWIFT_1"),
	PxrSwift_2 = 2 UMETA(DisplayName = "PXR_SWIFT_2"),
};

UENUM(BlueprintType)
enum class EPXRMotionTrackerMode: uint8
{
	PxrBodyTracking = 0 UMETA(DisplayName = "FULL_BODY"),
	PxrMotionTracking = 1 UMETA(DisplayName = "STAND_ALONE_TRACKER"),
};
